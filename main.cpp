...
void displayStatus()
{
    cout << setw(18) << "File name   : " << checkString(inputFile) << setw(20) << "File size: " << img.get_size() << " Bytes" << endl;

    cout << setw(18) << "Image width : " << img.get_width() << endl;
    cout << setw(18) << "Image height: " << img.get_height() << endl;
    cout << setw(18) << "Pixel count : " << img.pixel_count() << endl;
